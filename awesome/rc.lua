...
-- xrandr script
awful.spawn.easy_async_with_shell("~/.screenlayout/STD.sh")
...
beautiful.init("/home/robin/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({ "Mod1",           }, "space", function () awful.util.spawn("rofi -show run")  end,
              {description = "LÖL", group = "launcher"}),
...
awful.rules.rules = {
    ...
    -- Remove titlebars from:
     { rule = { class = "Steam"}, properties = { titlebars_enabled = false }},
     { rule = { class = "Terminator"}, properties = { titlebars_enabled = false }},
     { rule = { class = "Firefox"}, properties = { titlebars_enabled = false }},
     { rule = { class = "Brave"}, properties = { titlebars_enabled = false }},
     { rule = { class = "discord"}, properties = { titlebars_enabled = false }},
     { rule = { class = "obsidian"}, properties = { titlebars_enabled = false }},
    { rule = { class = "Emacs" }, properties = { titlebars_enabled = false, focus = false }},
